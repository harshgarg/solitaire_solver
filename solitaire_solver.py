...
def saveDeck(moves, x):
    ...
    output = open('solitaire_solved_decks_with_seed_after_1701.pkl', 'wb')
...
while(loop<500000):
    ...
    pkl_file = open('solitaire_solved_decks_with_seed_after_1701.pkl', 'rb')
